    ...
    const handleSignup = async (e) => {
        ...
        try {
            const response = await axios.post(
                "http://localhost:5000/vendor/signup", // Update with the correct endpoint if needed
                { userId, password }
            );
    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100">
            <div className="w-full sm:w-96 bg-white p-8 rounded-lg shadow-lg">
                <h2 className="text-2xl font-semibold text-center mb-6 text-gray-800">User Signup</h2>
